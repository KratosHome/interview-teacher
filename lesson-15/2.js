...
developer2.completeTask('finish a feature');
developer2.completeTask('fix bug');
developer2.completeTask('create a feature');


developer3.completeTask('test a feature');
developer3.completeTask('write bugreport');
developer3.completeTask('cry');


console.log(developer1.completedTasks.length); // 2
console.log(developer2.completedTasks.length); // 3
console.log(developer3.completedTasks.length); // 3
